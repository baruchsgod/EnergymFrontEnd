...
const UserSettings = () => {
    ...
    return (<div>
        ...
        <HeaderStatus
            ...
            backUrl="/InicioAdmin"
            backName="Inicio"
            currentName="Menú de finanzas"
        />
        <div className="container mt-5 mb-5 fade-in-card">
            <div className="row">
                <div className="col-sm-12 text-center mt-4">
                    <h2 className="section-heading">Opciones del menú de acciones de finanzas</h2>
                    <h3 className="section-subheading wow fadeIn" data-wow-duration="1s" data-wow-delay=".1s">Un sitio que contiene acceso a la asignación de las membresías, gestión de pagos, creación de notas de crédito y débito, además de la gestión de caja</h3>
                </div>
            </div>
