...
export default function OverDue() {
    ...
    return (<div>
        <Header />
        <HeaderStatus
            h1="Facturas vencidas trimestrales"
            backUrl="/Report/Menu"
            backName="Menú de reportes de transacciones vencidas"
            currentName="Facturas vencidas trimestrales"
        />
        {details.length > 0 ?
                ...
                <div className="row">
                    <div className="row mb-3 mt-3">
                        <div className="col-sm-12">
                            <h2 className="para-color mb-3">Reporte de facturas vencidas trimestrales</h2>
                        </div>
                        <hr />
                    </div>
                </div>
