        ...
        Axios.get("https://energymproject.herokuapp.com/userDetails", {
            ...
            .then(async (res) => {
                if (res.data.length > 0) {
                    Axios.get("https://energymproject.herokuapp.com/user", {credentials: 'include'})
                    .then(async (resp) => {
                        if(resp.data){
                    ...
                    <form onSubmit={findCustomer}>
                        ...
                        <div className="col-md-12 p-3 mt-5 ml-4" >
                            <div className="offset-md-2 col-md-7 ">
                                <h3 className="fw-bold text-center para-color ">Buscar cliente para crear una nota de crédito</h3>
                            </div>
