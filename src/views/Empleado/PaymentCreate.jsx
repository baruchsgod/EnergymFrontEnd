...
export default function Diet(props) {
    ...
    const { _id, name, newPayment, email, lName, membership } = (props.location && props.location.state) || {};
            ...
            Axios.post("https://energymproject.herokuapp.com/payments/creates", pago)
                .then(async response => {
                    if (response.data.length > 0) {
                        ...
                        setMsg("Ha ingresado el pago exitosamente");
                        ...
                        return await swal("Ha existido un error con la creación del pago!", {
                            icon: "error"
                        });
                    }
                })
    ...
    return (<div>
        ...
        <HeaderStatus
            h1="Crear pago"
            backUrl="/Payment"
            backName="Busqueda del cliente"
            currentName="Crear pago"
        />
        {payment.length === 0 ?
            <section className="">
                            ...
                            <div className="row">
                                <div className="row mb-3 mt-3">
                                    <div className="col-sm-12">
                                        <h2 className="para-color mb-3">Datos necesarios para la creación del pago</h2>
                                    </div>
                                    <hr />
                                </div>
                            </div>
                        ...
                        <Container className="d-flex align-items-center justify-content-center mt-5" style={{ minHeight: "50vh" }}>
                            <div className="w-100" style={{ maxWidth: "550px" }}>
                                <Card style={{ background: "rgb(128,128,128, 0.2)" }} className="backgroundTransparent p-3">
                                    <Card.Body>
                                        <h2 style={{ color: "#2B2B2B" }} className="text-center mb-4">Crear pago</h2>
                                        <Form onSubmit={createPayment}>
                                            <Form.Group>
                                                <Form.Label style={{ color: "#2B2B2B" }}>Monto del pago</Form.Label>
                                                <Form.Control type="number" min="1" max="500000" ref={montoRef} required />
                                            </Form.Group>
                                            ...
                                            <Form.Group>
                                                <Form.Label style={{ color: "#2B2B2B" }}>Su usuario</Form.Label>
                                            ...
                                            <div className="row bmi-box mt-3 mb-3">
                                                <div className="col-sm-12 fade-in-card">
                                                    <div className="contact-sub-btn text-center">
                                                        <button type="submit" className="btn btn-effect section-button w-100" style={{ width: "300px", padding: "10px" }}>Generar pago</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </Form>
            ...
            <div className="container fade-in-card" style={{ margin: "4% auto" }}>
                <div className="row">
                    <div className="row mb-3 mt-3">
                        <div className="col-sm-12">
                            <h2 className="para-color mb-3">Detalles del pago exitoso</h2>
                        </div>
                        <hr />
                    </div>
                </div>
                            ...
                            <div className="col-12 col-lg-10 offset-lg-1 p-4">
                                ...
                                <div className="mt-4">
                                    <div className="row text-600 text-white bgc-default-tp1 py-25">
                                        <div className="d-none d-sm-block col-1">Número de pago</div>
                ...
                <div className="col-md-6 mb-5 mt-5 offset-md-4 fade-in-card ">
                    <Link to="/EmpleadoMenuPagos" style={{ textDecoration: 'none' }}><Button type="button" className="w-50 btn BotonesColor">Continuar</Button></Link>
                </div>
            </div>
        }
        <Footer />
